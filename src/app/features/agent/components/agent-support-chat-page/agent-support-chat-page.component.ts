...
@Component({
  ...
  template: `
    <div class="mx-auto w-full max-w-[1500px] px-3 pb-4 sm:px-4 lg:px-6" *ngIf="ready(); else loadingState">
      <div class="mb-3">
        <a routerLink="/agent/support-chats" class="inline-flex items-center gap-2 rounded-full border border-border bg-white/80 px-3 py-2 text-[13px] font-medium text-secondary no-underline shadow-sm transition hover:text-primary">
